...
svg(out)
# First distribution
hist(Ixos, breaks=50, xlim=c(0,0.5), ylim=c(0,600000), col=rgb(1,0,0,0.5), xlab="Minor Allele Frequency", 
     ylab="Frequency", main="Minor Allele Frequency" )

# Second with add=T to plot on top
hist(Primadur, breaks=50, xlim=c(0,0.5), ylim=c(0,600000), col=rgb(0,0,1,0.5), add=T)
