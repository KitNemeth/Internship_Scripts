...
mds_andean <- MDS(dist = allDist,info = andean,group = "Geographic",k = 2,main = "South American Accessions",pdfFile = "MasterLandraceTeoInbredGBS_collapseDist0.02_andean_MDS.svg")