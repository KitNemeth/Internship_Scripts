...
taxalist <- read.table(file("SALandrace_covfilt0.1_taxalist.txt"),skip=1,sep="\t")
taxalist <- as.vector(t(as.matrix(taxalist)))
kinship <- as.data.frame(fread("maize_kinship_SA.txt",sep="\t",skip=3,stringsAsFactors = F))
...
line1 = '##Centered_IBS.SumPk=170336.95138636293'
line2 = '##Matrix_Type=Centered_IBS'
line3 = '3250'
file_name = "maize_Kinship_SA_R.txt"
