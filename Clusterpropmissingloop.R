...
Clustered_data <- as.data.frame(fread("All_taxa_pheatmap_clusters.txt"))
...
for(i in 1:17){
  ...
  assign(paste("K",i,sep=""),as.data.frame(c(get(paste("C",i,sep=""))[sample(nrow(get(paste("C",i,sep=""))), 12), ])))
