...
mds_Americas <- MDS(dist = allDist,info = Americas,group = "Beck",k = 2,main = "American Accessions",pdfFile = "MasterLandraceTeoInbredGBS_collapseDist0.02_Americas_MDS_Beck.svg")
