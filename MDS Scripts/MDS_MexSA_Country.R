...
mds_MexSA <- MDS(dist = allDist,info = MexSA,group = "Country",k = 2,main = "Central and South American Accessions",pdfFile = "MasterLandraceTeoInbredGBS_collapseDist0.02_CSA_MDS_Country.svg")
