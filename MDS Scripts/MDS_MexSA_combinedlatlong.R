...
mds_MexSA <- MDS(dist = allDist,info = MexSA,group = "combinedLatLong",k = 2,main = "Central and South American Accessions",pdfFile = "MasterLandraceTeoInbredGBS_collapseDist0.02_CSA_MDS_LatLong.svg")
