...
mds_andean <- MDS(dist = allDist,info = andean,group = "combinedGeo",k = 2,main = "South American Accessions",pdfFile = "MasterLandraceTeoInbredGBS_collapseDist0.02_andean_MDS_Geo.svg")
