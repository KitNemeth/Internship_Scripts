...
mds_Americas2 <- MDS(dist = allDist,info = Americas,group = "Seed",k = 2,main = "American Accessions",pdfFile = "MasterLandraceTeoInbredGBS_collapseDist0.02_Americas_MDS_Seed.svg")
